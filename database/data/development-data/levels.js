module.exports = [
  {
    ...
    threat_index: 1,
    image:
      "https://static.wikia.nocookie.net/backrooms/images/0/05/Thebackrooms.jpg/revision/latest/scale-to-width-down/300?cb=20230105020740&format=original",
    ambience:
      "https://static.wikia.nocookie.net/backrooms/images/a/a7/Level0LightAmbience.mp3",
...
`,
    entity_information: `As reports are inconsistent and difficult to verify, it is unknown whether entities exist within Level 0. In addition, no interactions with other wanderers have ever been reported during explorations, as the individual wanderer is isolated at all times.`,
    entrances: `Level 0, and by extension, the Backrooms, can be accessed by accidentally noclipping out-of-bounds in normal reality. In addition, many levels can lead one to Level 0.`,
    exits: [
